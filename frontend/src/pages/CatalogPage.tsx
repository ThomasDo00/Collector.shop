...
const MOCK_PRODUCTS: ProductPreview[] = [
  ...
  { id: '3', title: 'Vinyle Pink Floyd - The Wall Edition Limitee', price: 75, imageUrl: 'https://images.unsplash.com/photo-1539375665275-f9de415ef9ac?w=400', category: 'Vinyles', condition: 'like_new', status: 'active', seller: { id: '3', username: 'vinyl_addict', rating: 5 }, createdAt: '2024-01-13' },
